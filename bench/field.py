...
"""Teams on every map, spawn order shuffled per attempt.
    ...
    uv run bench/field.py --team pddl,pddl --team naive --missions
...
parser.add_argument(
    "--missions",
    nargs="?",
    const="bench/missions/standard.json",
    help="missions a director acts out during every run; the standard set unless a file is given",
)
